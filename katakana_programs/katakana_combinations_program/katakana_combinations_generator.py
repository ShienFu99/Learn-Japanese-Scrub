...
def main():
    ...
    katakana_combinations = [
        {"katakana": "キャ", "rōmaji": "kya"},
        {"katakana": "キュ", "rōmaji": "kyu"},
        {"katakana": "キョ", "rōmaji": "kyo"},
        {"katakana": "シャ", "rōmaji": "sha"},
        {"katakana": "シュ", "rōmaji": "shu"},
        {"katakana": "ショ", "rōmaji": "sho"},
        {"katakana": "チャ", "rōmaji": "cha"},
        {"katakana": "チュ", "rōmaji": "chu"},
        {"katakana": "チョ", "rōmaji": "cho"},
        {"katakana": "ニャ", "rōmaji": "nya"},
        {"katakana": "ニュ", "rōmaji": "nyu"},
        {"katakana": "ニョ", "rōmaji": "nyo"},
        {"katakana": "ヒャ", "rōmaji": "hya"},
        {"katakana": "ヒュ", "rōmaji": "hyu"},
        {"katakana": "ヒョ", "rōmaji": "hyo"},
        {"katakana": "ミャ", "rōmaji": "mya"},
        {"katakana": "ミュ", "rōmaji": "myu"},
        {"katakana": "ミョ", "rōmaji": "myo"},
        {"katakana": "リャ", "rōmaji": "rya"},
        {"katakana": "リュ", "rōmaji": "ryu"},
        {"katakana": "リョ", "rōmaji": "ryo"},
        {"katakana": "ギャ", "rōmaji": "gya"},
        {"katakana": "ギュ", "rōmaji": "gyu"},
        {"katakana": "ギョ", "rōmaji": "gyo"},
        {"katakana": "ジャ", "rōmaji": "ja"},
        {"katakana": "ジュ", "rōmaji": "ju"},
        {"katakana": "ジョ", "rōmaji": "jo"},
        {"katakana": "ヂャ", "rōmaji": "ja"},
        {"katakana": "ヂュ", "rōmaji": "ju"},
        {"katakana": "ヂョ", "rōmaji": "jo"},
        {"katakana": "ビャ", "rōmaji": "bya"},
        {"katakana": "ビュ", "rōmaji": "byu"},
        {"katakana": "ビョ", "rōmaji": "byo"},
        {"katakana": "ピャ", "rōmaji": "pya"},
        {"katakana": "ピュ", "rōmaji": "pyu"},
        {"katakana": "ピョ", "rōmaji": "pyo"},
        {"katakana": "ウィ", "rōmaji": "wi"},
        {"katakana": "ウェ", "rōmaji": "we"},
        {"katakana": "ウォ", "rōmaji": "wo"},
        {"katakana": "ヴァ", "rōmaji": "va"},
        {"katakana": "ヴィ", "rōmaji": "vi"},
        {"katakana": "ヴ", "rōmaji": "vu"},
        {"katakana": "ヴェ", "rōmaji": "ve"},
        {"katakana": "ヴォ", "rōmaji": "vo"},
        {"katakana": "シェ", "rōmaji": "she"},
        {"katakana": "ジェ", "rōmaji": "je"},
        {"katakana": "ファ", "rōmaji": "fa"},
        {"katakana": "フィ", "rōmaji": "fi"},
        {"katakana": "フェ", "rōmaji": "fe"},
        {"katakana": "フォ", "rōmaji": "fo"},
        {"katakana": "ティ", "rōmaji": "ti"},
        {"katakana": "ディ", "rōmaji": "di"},
        {"katakana": "トゥ", "rōmaji": "tu"},
        {"katakana": "ドゥ", "rōmaji": "du"},
        {"katakana": "チェ", "rōmaji": "che"}
    ]
    ...
    katakana_str, katakana_str_translation = generate_katakana_str(katakana_combinations, difficulty_level)
...
def get_difficulty_level():
    #Prompts user to input a difficulty level between 1 and 55 (inclusive) -> Reprompts until input is valid, then returns it to main
    while True:
        try:
            difficulty_level = int(input("Set level (between 1 and 55): "))
            if difficulty_level > 55 or difficulty_level < 1:
                raise ValueError
...
def generate_katakana_str(katakana_combinations, difficulty_level):
    katakana_str = ""
    ...
    while difficulty_level != 0:
        ...
        katakana_char = choice(katakana_combinations)
        ...
        katakana_combinations.remove(katakana_char)
