...
def main():
    ...
    #Maps each hiragana symbol to its rōmaji equivalent
    hiragana_combinations = [
        {"hiragana": "きゃ", "rōmaji": "kya"},
        {"hiragana": "きゅ", "rōmaji": "kyu"},
        {"hiragana": "きょ", "rōmaji": "kyo"},
        {"hiragana": "しゃ", "rōmaji": "sha"},
        {"hiragana": "しゅ", "rōmaji": "shu"},
        {"hiragana": "しょ", "rōmaji": "sho"},
        {"hiragana": "ちゃ", "rōmaji": "cha"},
        {"hiragana": "ちゅ", "rōmaji": "chu"},
        {"hiragana": "ちょ", "rōmaji": "cho"},
        {"hiragana": "にゃ", "rōmaji": "nya"},
        {"hiragana": "にゅ", "rōmaji": "nyu"},
        {"hiragana": "にょ", "rōmaji": "nyo"},
        {"hiragana": "ひゃ", "rōmaji": "hya"},
        {"hiragana": "ひゅ", "rōmaji": "hyu"},
        {"hiragana": "ひょ", "rōmaji": "hyo"},
        {"hiragana": "みゃ", "rōmaji": "mya"},
        {"hiragana": "みゅ", "rōmaji": "myu"},
        {"hiragana": "みょ", "rōmaji": "myo"},
        {"hiragana": "りゃ", "rōmaji": "rya"},
        {"hiragana": "りゅ", "rōmaji": "ryu"},
        {"hiragana": "りょ", "rōmaji": "ryo"},
        {"hiragana": "ぎゃ", "rōmaji": "gya"},
        {"hiragana": "ぎゅ", "rōmaji": "gyu"},
    ...
    hiragana_str, hiragana_str_translation = generate_hiragana_str(hiragana_combinations, difficulty_level)
...
def get_difficulty_level():
    #Prompts user to input a difficulty level between 1 and 36 (inclusive) -> Reprompts until input is valid, then returns it to main
    while True:
        try:
            difficulty_level = int(input("Set level (between 1 and 36): "))
            if difficulty_level > 36 or difficulty_level < 1:
                raise ValueError
...
def generate_hiragana_str(hiragana_combinations, difficulty_level):
    hiragana_str = ""
    ...
    while difficulty_level != 0:
        ...
        hiragana_char = choice(hiragana_combinations)
        ...
        hiragana_combinations.remove(hiragana_char)
