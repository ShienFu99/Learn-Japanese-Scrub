...
def main():
    ...
    hiragana_dakuten_handakuten = [
        {"hiragana": "が", "rōmaji": "ga"},
        {"hiragana": "ぎ", "rōmaji": "gi"},
        {"hiragana": "ぐ", "rōmaji": "gu"},
        {"hiragana": "げ", "rōmaji": "ge"},
        {"hiragana": "ご", "rōmaji": "go"},
        {"hiragana": "ざ", "rōmaji": "za"},
        {"hiragana": "じ", "rōmaji": "ji"},
        {"hiragana": "ず", "rōmaji": "zu"},
        {"hiragana": "ぜ", "rōmaji": "ze"},
        {"hiragana": "ぞ", "rōmaji": "zo"},
        {"hiragana": "だ", "rōmaji": "da"},
        {"hiragana": "で", "rōmaji": "de"},
        {"hiragana": "ど", "rōmaji": "do"},
        {"hiragana": "ば", "rōmaji": "ba"},
        {"hiragana": "び", "rōmaji": "bi"},
        {"hiragana": "ぶ", "rōmaji": "bu"},
        {"hiragana": "べ", "rōmaji": "be"},
        {"hiragana": "ぼ", "rōmaji": "bo"},
        {"hiragana": "ぱ", "rōmaji": "pa"},
        {"hiragana": "ぴ", "rōmaji": "pi"},
        {"hiragana": "ぷ", "rōmaji": "pu"},
        {"hiragana": "ぺ", "rōmaji": "pe"},
        {"hiragana": "ぽ", "rōmaji": "po"}
    ]
    ...
    hiragana_str, hiragana_str_translation = generate_hiragana_str(hiragana_dakuten_handakuten, difficulty_level)
...
def generate_hiragana_str(hiragana_dakuten_handakuten, difficulty_level):
    hiragana_str = ""
    ...
    while difficulty_level != 0:
        ...
        hiragana_char = choice(hiragana_dakuten_handakuten)
        ...
        hiragana_dakuten_handakuten.remove(hiragana_char)
